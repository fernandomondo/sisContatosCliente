	...
	<div class="col-md-6">	
		<form action="contato-criar.php" method="post" role="form">	
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="telefone" name="telefone" value="<?php echo $model->contato->gettelefone(); ?>" placeholder="telefone do contato" required maxlength="10">
		  </div>
		  <div class="form-group">
		    <label for="celular">Celular</label>
		    <input type="text" class="form-control" id="celular" name="celular" value="<?php echo $model->contato->getCelular(); ?>" placeholder="celular do contato" required maxlength="10">
		  </div>
		  <div class="form-group">
		    <label for="email">Email</label>
		    <input type="text" class="form-control" id="email" name="email" value="<?php echo $model->contato->getEmail(); ?>" placeholder="email do contato" required maxlength="30">
		  </div>
		  <div class="form-group">
		    <label for="dataNasc">Data de Nascimento</label>
		    <input type="text" class="form-control" id="dataNasc" name="dataNasc" value="<?php echo $model->contato->getDataNasc(); ?>" placeholder="dataNasc do contato" required>
		  </div>
